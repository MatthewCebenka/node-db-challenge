...
A relational database stores things. SQL is structured query language and is used to interact with the data base.
...
A bridge table that uses foreign keys to connect other tables.
